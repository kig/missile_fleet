...
/**
  ...
  */
window.Canvas = Klass(CanvasNode, {
  ...
  */
  ...
  addEventListeners : function() {
    ...
    this.canvas.parentNode.addMouseEvent = function(e){
      var bbox = th.canvas.getBoundingClientRect();
      th.absoluteMouseX = (e.clientX - bbox.left) * devicePixelRatio;
      th.absoluteMouseY = (e.clientY - bbox.top) * devicePixelRatio;
      var w = bbox.width;
      var h = bbox.height;
      th.mouseX = th.absoluteMouseX;
      th.mouseY = th.absoluteMouseY;
