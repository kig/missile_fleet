...
export const Level = Klass(CanvasNode, {
    ...
    initialize: function () {
        ...
        this.mouseupHandler = function (ev) {
            ...
            if (selectionStart && th.selectRect.visible) {
                ...
                selectionStart &&
                (ev.canvasTarget == th.selectRect || ev.canvasTarget == th.bg)
            ) {
        ...
        this.addEventListener(
            ...
            function (ev) {
                if (ev.canvasTarget == this) {
                    ...
                    ev.relatedTarget.addEventListener(
                        "mouseup",
                        this.mouseupHandler,
                        false
                    );
        ...
        this.addFrameListener(function () {
            if (Player.selection.length > 0) this.cursor = MOVE_TO_CURSOR;
    ...
    query: function (header) {
        ...
        var msg = new ElementNode(div, { x: 320, y: 30, align: "center" });
    ...
    notify: function (message, after, duration) {
        ...
        this.after(after, function () {
            ...
            if (!duration)
                duration = 3500 + msg.element.textContent.length * 10;
            msg.opacity = 0;
            msg.animateTo("opacity", 1, 500, "sine");
    ...
    gameOver: function () {
        ...
        this.after(1000, function () {
            this.query(
                E("h1", "Your fleet was destroyed"),
                "Try again",
                function () {
                    this.parentNode.tryAgain();
                },
                "Back to main menu",
                function () {
                    this.parentNode.gameOver();
